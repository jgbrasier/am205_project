...
for noise_lvl in noise_lvls:
    ...
    # logdir
    logpath = r'DeepMod/logs/lotkavoltera_' + str(noise_lvl)

    train(model, X, y, optimizer, sparsity_scheduler, log_dir=logpath, split=0.8, max_iterations=150000, patience=200, delta=1e-5) 
    ...
    plt.ylabel('y')
    plt.tight_layout()
    plt.savefig("DeepMod/figs/lv/lotkavolterra_pred_{}.png".format(noise_lvl))
...
plt.tight_layout()
plt.savefig("DeepMod/figs/lv/lotkavolterra_sim.png")
...
plt.savefig("DeepMod/figs/lv/lotkavolterra_err.png")